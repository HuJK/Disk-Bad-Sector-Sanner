...
# Create four 200MB loop devices backed by sparse files for testing disk_scan.
# Usage: ./scripts/create_loops_samesize.sh

BASE_DIR=${BASE_DIR:-/tmp/disk-scan-loops-same}
mkdir -p "$BASE_DIR"

sizes=(200M 200M 200M 200M)
created=()
